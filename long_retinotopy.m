...
randparams = [9,10,11,12,5,6,7,8,1,2,3,4]; 
resttimes = [6,6,6,6,6,6,6,6,6,6,6,6] ; 
allrounds = [2,2,2,2,2,2,2,2,2,2,2,2] ; 
...
barframes = stimframes ; 
barincr = size(xg,1)./barframes ; 
barcount = 1 ; 
for i=-37.5:barincr/8:37.5+1
    width = (abs(i))/4+5 ; 
...
stimtypeframes = [stimframes,stimframes,stimframes,stimframes,stimframes,stimframes,stimframes,stimframes,stimframes,stimframes,stimframes,stimframes] ; 
    ...
    while ~DONE             
        ...
        if currentstate == 2 % present the stimulus               
            ...
            elseif randparams(presentation)==5
                Screen('DrawTexture',w,bartex(stimcount),[],[barw1,barh1,barw2,barh2],0) ;
                Screen('DrawTexture',w,xhairtex) ;  
                Screen('DrawTexture',w,xhairsmalltex) ; 
            elseif randparams(presentation)==6
                Screen('DrawTexture',w,bartex(stimcount),[],[barw1,barh1,barw2,barh2],180) ;
                Screen('DrawTexture',w,xhairtex) ;  
                Screen('DrawTexture',w,xhairsmalltex) ; 
            elseif randparams(presentation)==7
                Screen('DrawTexture',w,bartex(stimcount),[],[barw1,barh1,barw2,barh2],90) ;
                Screen('DrawTexture',w,xhairtex) ;  
                Screen('DrawTexture',w,xhairsmalltex) ; 
            elseif randparams(presentation)==8
                Screen('DrawTexture',w,bartex(stimcount),[],[barw1,barh1,barw2,barh2],270) ;
                Screen('DrawTexture',w,xhairtex) ;  
                Screen('DrawTexture',w,xhairsmalltex) ; 
            elseif randparams(presentation)==9
                Screen('DrawTexture',w,bartex(stimcount),[],[barw1,barh1,barw2,barh2],45) ;
                Screen('DrawTexture',w,xhairtex) ;  
                Screen('DrawTexture',w,xhairsmalltex) ; 
            elseif randparams(presentation)==10
                Screen('DrawTexture',w,bartex(stimcount),[],[barw1,barh1,barw2,barh2],135) ;
                Screen('DrawTexture',w,xhairtex) ;  
                Screen('DrawTexture',w,xhairsmalltex) ; 
            elseif randparams(presentation)==11
                Screen('DrawTexture',w,bartex(stimcount),[],[barw1,barh1,barw2,barh2],315) ;
                Screen('DrawTexture',w,xhairtex) ;  
                Screen('DrawTexture',w,xhairsmalltex) ; 
            elseif randparams(presentation)==12
                Screen('DrawTexture',w,bartex(stimcount),[],[barw1,barh1,barw2,barh2],225) ;
                Screen('DrawTexture',w,xhairtex) ;  
                Screen('DrawTexture',w,xhairsmalltex) ; 
