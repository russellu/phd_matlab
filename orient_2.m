    ...
    for presentation = 1:size(presentorder,2) 
        ...
        while ~DONE             
            ...
            if currentstate == 2 % present the stimulus               
                xoffset = mod(stimcount*shiftperframe/2,360);  % Shift the grating by "shiftperframe" pixels per frame:
                srcRect=[xoffset 0 xoffset + visiblesize visiblesize];           
                Screen('DrawTexture',w,sgtex,srcRect,[],orientations(presentorder(presentation))) ;   
