...
stimtypeframes = [stimframes,stimframes,stimframes,stimframes] ; 
restframes = frameRate*resttime ; 
    ...
    while ~DONE             
        ...
        if currentstate == 1 % present the dark red and bright red crosshairs (focus period)
            ...
            if focuscount > focusframes + jitter
                ...
                if trigsON
                        io64(ioObj,parallelPortAddress,randparams(presentation));
                        WaitSecs(2/EEGfreq)
                        io64(ioObj,parallelPortAddress,LPT1_resetValue);
                end
            end
        end            
