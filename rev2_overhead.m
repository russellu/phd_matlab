...
for ccy=1:length(currs) ; 
    ...
    clear allprofits alltracks allntrades alltrackprofits
    ...
    results{1} = allprofits ; results{2} = allntrades ; results{3} = alltracks ; results{4} = alltrackprofits ; 
    save(['rev2_results_',currs{ccy}],'results') ; 
end